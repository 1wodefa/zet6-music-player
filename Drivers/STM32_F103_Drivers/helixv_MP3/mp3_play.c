...
* Input          : Adress of buffer data, number of input samples (outputSamps from decoder)
* Output         : None
* Return         : None
*/
/************************************************************************************/
void Convert_Stereo(short *buffer, int nSamps)
{
	int i,j,k;
...
* Description    : after decoder a frame of Mono MP3,the buffer will fill by nSamps halfword,this function
